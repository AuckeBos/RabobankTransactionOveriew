...
class Data(object):
    ...
    def getTransactions(self, soup, index, start, end):
        ...
        if input != None:
            ...
            request = self.session.get(
                "https://bankieren.rabobank.nl/klanten/particulieren/internetbankieren/betalensparen/default.html/transactionoverview-web/transaction-overview/961058994/ver=2.0/resource/id=searchHistory/rparam=p7=" + end + "/rparam=p6=" + start + "/rparam=index=" + index + "/rparam=p1=false/rparam=render=transactionSearchResult/rparam=p8.wsp/pparam=index" + index,
